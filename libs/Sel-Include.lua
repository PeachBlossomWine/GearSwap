...
function init_include()
	...
	state.AutoSambaMode 	  = M{['description']= 'Auto Samba Mode', 'Off', 'Haste', 'Aspir', 'Drain'}
...
function default_filtered_action(spell, eventArgs)
    if not (player.status =='Dead' or player.status == 'Engaged dead') then
...
function apply_kiting(baseSet)
	--and (state.IdleMode.value == 'Normal' or state.IdleMode.value:contains('Sphere') or state.IdleMode.value == 'DT' or state.IdleMode.value == 'Refresh')
	if sets.Kiting and (state.Kiting.value or (player.status == 'Idle' and moving and state.DefenseMode.value == 'None' and state.Passive.value == 'None')) then
