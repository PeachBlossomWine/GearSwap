...
state.Weapons:options('TizThib','TizZan','TizSak','TizBunzi','NaegThib','NaegZan','Maxentius','Magic','MACC','Learn','None')
...
send_command('wait 5; hb disable allcure; hb disable curaga; hb disable na')
