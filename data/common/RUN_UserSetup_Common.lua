...
state.Weapons:options('Epeolatry','Lionheart','KajaChopper','None')
autows = 'Dimidiation'
...
send_command('bind ^backspace input /ja "Rayke" <t>') -- <t>; input /p Rayke 35s duration; wait 10; input /p Rayke 25s remaining; wait 10; input /p Rayke 15s remaining; wait 10; input /p Rayke 5s remaining')
send_command('bind @backspace input /ja "Gambit" <t>')--; input /p Gambit 75s duration; wait 15; input /p Gambit 60s remaining; wait 15; input /p Gambit 45s remaining; wait 15; input /p Gambit 30s remaining; wait 15; input /p Gambit 15s remaining;')
