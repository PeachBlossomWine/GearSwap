...
send_command('bind ^backspace input /ja "Rayke" <t>; input /p Rayke 35s 時間の長さ; wait 10; input /p Rayke 25s 残り; wait 10; input /p Rayke 15s 残り; wait 10; input /p Rayke 5s 残り')
send_command('bind @backspace input /ja "Gambit" <t>; input /p Gambit 75s 時間の長さ; wait 15; input /p Gambit 60s 残り; wait 15; input /p Gambit 45s 残り; wait 15; input /p Gambit 30s 残り; wait 15; input /p Gambit 15s 残り;')
